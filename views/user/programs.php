...
// --- list programs visible to same location ---
...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* Program list items (subtle cards, same vibe as Projects) */
...
<body>
  ...
  <div class="main">
    ...
    <div class="content-box">
      ...
      <?php elseif (!$rows): ?>
        <div style="opacity:.9; margin-top:14px;">No <?= strtolower($TYPE) ?>s found for <?= htmlspecialchars($userLoc, ENT_QUOTES) ?>.</div>
      <?php else: ?>
  ...
  <script>
    // auto-submit the upload form when a file is picked
